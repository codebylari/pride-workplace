          ...
          <div className="w-full max-w-md bg-white/15 backdrop-blur-lg rounded-3xl p-10 space-y-8 border border-white/20 shadow-xl">
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <Button
                type="submit"
                disabled={loading}
                className="w-full bg-pink-300/90 hover:bg-pink-400 text-pink-900 py-6 rounded-full text-lg font-semibold shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 disabled:opacity-50"
              >
